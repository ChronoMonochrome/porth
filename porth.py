...
def generate_nasm_linux_arm32(program: Program, out_file_path: str):
    ...
    with open(out_file_path, "w") as out:
        ...
        out.write("   mov	r2, #10\n")
        out.write("   mov	r3, #0\n")
        out.write("   push	{r4, lr}\n")
        out.write("   bl	__aeabi_uldivmod\n")
        out.write("   pop	{r4, pc}\n")
        out.write("print:\n")
        out.write("   push	{r4, r5, r6, r7, lr}\n")
        out.write("   sub	sp, sp, #36	// 0x24\n")
        out.write("   mov	r4, r0\n")
        out.write("   add	r7, sp, #31\n")
        out.write("   mov	r5, r1\n")
        out.write("   mov	r6, #1\n")
        out.write("   mov	r3, #10\n")
        out.write("   strb	r3, [sp, #31]\n")
        out.write(".L0:\n")
        out.write("   mov	r0, r4\n")
        out.write("   mov	r1, r5\n")
        out.write("   mov	r2, #10\n")
        ...
        out.write("   mov	r0, r4\n")
        out.write("   mov	r1, r5\n")
        out.write("   add	r2, r2, #48	// 0x30\n")
        out.write("   add	r6, r6, #1\n")
        out.write("   strb	r2, [r7, #-1]!\n")
        out.write("   bl	div10\n")
        out.write("   mov	r4, r0\n")
        out.write("   mov	r5, r1\n")
        out.write("   orrs	r3, r4, r5\n")
        out.write("   bne	.L0 // <dump+0x20>\n")
        out.write("   add	r3, sp, #32\n")
        out.write("   mov	r2, r6\n")
        out.write("   sub	r1, r3, r6\n")
        out.write("   mov	r0, #1\n")
        out.write("   mov  r7, #4\n")
        out.write("   swi  0\n")
        out.write("   add	sp, sp, #36	// 0x24\n")
        out.write("   pop	{r4, r5, r6, r7, pc}\n")
        out.write("__aeabi_uldivmod:\n")
        out.write("   cmp	r3, #0\n")
        out.write(".L1:\n")
        out.write("   sub	sp, sp, #8\n")
        out.write("   push	{sp, lr}\n")
        out.write("   bl	__udivmoddi4 // <__udivmoddi4>\n")
        out.write("   ldr	lr, [sp, #4]\n")
        out.write("   add	sp, sp, #8\n")
        out.write("   pop	{r2, r3}\n")
        out.write("   bx	lr\n")
        out.write("__udivmoddi4:\n")
        out.write("   cmp	r1, r3\n")
        out.write("   cmpeq	r0, r2\n")
        out.write("   push	{r4, r5, r6, r7, r8, r9, sl, fp, lr}\n")
        out.write("   mov	r4, r0\n")
        out.write("   movcc	r0, #0\n")
        out.write("   mov	r5, r1\n")
        out.write("   ldr	lr, [sp, #36]	// 0x24\n")
        out.write("   movcc	r1, r0\n")
        out.write("   bcc	.L3 // <__udivmoddi4+0x124>\n")
        out.write("   cmp	r3, #0\n")
        out.write("   clzeq	ip, r2\n")
        out.write("   clzne	ip, r3\n")
        out.write("   addeq	ip, ip, #32\n")
        out.write("   cmp	r5, #0\n")
        out.write("   mov	r7, r3\n")
        out.write("   clzeq	r3, r4\n")
        out.write("   clzne	r3, r5\n")
        out.write("   addeq	r3, r3, #32\n")
        out.write("   sub	ip, ip, r3\n")
        out.write("   sub	sl, ip, #32\n")
        out.write("   lsl	r9, r7, ip\n")
        out.write("   orr	r9, r9, r2, lsl sl\n")
        out.write("   rsb	fp, ip, #32\n")
        out.write("   orr	r9, r9, r2, lsr fp\n")
        out.write("   cmp	r5, r9\n")
        out.write("   lsl	r8, r2, ip\n")
        out.write("   cmpeq	r4, r8\n")
        out.write("   movcc	r0, #0\n")
        out.write("   mov	r6, r2\n")
        out.write("   movcc	r1, r0\n")
        out.write("   bcc	.L2 // <__udivmoddi4+0x94>\n")
        out.write("   mov	r0, #1\n")
        out.write("   subs	r4, r4, r8\n")
        out.write("   lsl	r1, r0, sl\n")
        out.write("   orr	r1, r1, r0, lsr fp\n")
        out.write("   sbc	r5, r5, r9\n")
        out.write("   lsl	r0, r0, ip\n")
        out.write(".L2:\n")
        out.write("   cmp	ip, #0\n")
        out.write("   beq	.L3 // <__udivmoddi4+0x124>\n")
        out.write("   lsr	r6, r8, #1\n")
        out.write("   mov	r2, ip\n")
        out.write("   orr	r6, r6, r9, lsl #31\n")
        out.write("   lsr	r7, r9, #1\n")
        out.write("   b	.L4 // <__udivmoddi4+0xd0>\n")
        out.write(".L5:\n")
        out.write("   subs	r3, r4, r6\n")
        out.write("   sbc	r8, r5, r7\n")
        out.write("   adds	r3, r3, r3\n")
        out.write("   adc	r8, r8, r8\n")
        out.write("   adds	r4, r3, #1\n")
        out.write("   adc	r5, r8, #0\n")
        out.write("   subs	r2, r2, #1\n")
        out.write("   beq	.L6 // <__udivmoddi4+0xec>\n")
        out.write(".L4:\n")
        out.write("   cmp	r5, r7\n")
        out.write("   cmpeq	r4, r6\n")
        out.write("   bcs	.L5 // <__udivmoddi4+0xb0>\n")
        out.write("   adds	r4, r4, r4\n")
        out.write("   adc	r5, r5, r5\n")
        out.write("   subs	r2, r2, #1\n")
        out.write("   bne	.L4 // <__udivmoddi4+0xd0>\n")
        out.write(".L6:\n")
        out.write("   lsr	r3, r4, ip\n")
        out.write("   orr	r3, r3, r5, lsl fp\n")
        out.write("   orr	r3, r3, r5, lsr sl\n")
        out.write("   adds	r0, r0, r4\n")
        out.write("   mov	r4, r3\n")
        out.write("   lsr	r2, r5, ip\n")
        out.write("   adc	r1, r1, r5\n")
        out.write("   mov	r5, r2\n")
        out.write("   lsl	r3, r2, ip\n")
        out.write("   orr	r3, r3, r4, lsl sl\n")
        out.write("   lsl	ip, r4, ip\n")
        out.write("   subs	r0, r0, ip\n")
        out.write("   orr	r3, r3, r4, lsr fp\n")
        out.write("   sbc	r1, r1, r3\n")
        out.write(".L3:\n")
        out.write("   cmp	lr, #0\n")
        out.write("   popeq	{r4, r5, r6, r7, r8, r9, sl, fp, pc}\n")
        out.write("   stm	lr, {r4, r5}\n")
        out.write("   pop	{r4, r5, r6, r7, r8, r9, sl, fp, pc}\n")
        out.write(".global _start\n")
        out.write("_start:\n")
        ...
        for ip in range(len(program.ops)):
            op = program.ops[ip]
            assert len(OpType) == 18, "Exhaustive ops handling in generate_nasm_linux_arm32"
            out.write("// ip = %d, op=%s\n" % (ip, str(op.typ)))
            out.write("addr_%d:\n" % ip)
            if op.typ in [OpType.PUSH_INT, OpType.PUSH_BOOL, OpType.PUSH_PTR]:
                assert isinstance(op.operand, int), f"This could be a bug in the parsing step {op.operand}"
                out.write("// [OpType.PUSH_INT, OpType.PUSH_BOOL, OpType.PUSH_PTR]\n")
                out.write("    ldr r1, =%d\n" % (op.operand & 0xffffffff))
                out.write("    ldr r10, =%d\n" % ((op.operand >> 32) & 0xffffffff))
                out.write("    push {r10}\n")
                out.write("    push {r1}\n")
            elif op.typ == OpType.PUSH_STR:
                out.write("// PUSH_STR\n")
                ...
                if op.operand == Intrinsic.PLUS:
                    ...
                    out.write("    pop {r1}\n")
                    out.write("    pop {r10}\n")
                    out.write("    vmov s14, r1\n")
                    out.write("    vmov s15, r2\n")
                    out.write("    vcvt.f32.s32 s14, s14\n")
                    out.write("    vcvt.f32.s32 s15, s15\n")
                    out.write("    vdiv.f32 s13, s14, s15\n")
                    out.write("    vcvt.s32.f32 s15, s13\n")
                    out.write("    vmov r3, s15\n")
                    out.write("    push {r10}\n")
                    out.write("    push {r3}\n")
                    out.write("    mul r4, r3, r2\n")
                    out.write("    sub r4, r1, r4\n")
                    out.write("    push {r9}\n")
                    out.write("    push {r4}\n")
                elif op.operand == Intrinsic.SHR:
                    out.write("    pop {r1}\n")
...
if __name__ == '__main__' and '__file__' in globals():
    ...
    if subcommand == "check":
        ...
        generate_nasm_linux_arm32(program, basepath + ".asm")
