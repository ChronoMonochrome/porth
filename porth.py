...
def generate_gas_linux_arm32(program: Program, out_file_path: str):
    strs: List[bytes] = []
    with open(out_file_path, "w") as out:
        ...
        out.write("print:\n")
        out.write("    mov    r3, #10\n")
        out.write("    push    {r4, r5, r6, r7, r8, r9, lr}\n")
        out.write("    sub    sp, sp, #44\n")
        out.write("    add    ip, sp, #40\n")
        out.write("    eor    r9, r0, r0, asr #31\n")
        out.write("    lsr    r2, r0, #31\n")
        out.write("    sub    r9, r9, r0, asr #31\n")
        out.write("    strb    r3, [ip, #-4]!\n")
        out.write("    mov    r1, #1 \n")
        out.write("    ldr    r8, .L8\n")
        out.write("    ldr    lr, .L8+4\n")
        out.write("    b    .L2\n")
        out.write(".L5:\n")
        out.write("    mov    r1, r3 \n")
        out.write(".L2:\n")
        out.write("    smull    r6, r7, r9, r8\n")
        out.write("    asr    r3, r9, #31\n")
        out.write("    smull    r4, r5, r9, lr\n")
        out.write("    rsb    r3, r3, r7, asr #2\n")
        out.write("    add    r3, r3, r3, lsl #2\n")
        out.write("    sub    r3, r9, r3, lsl #1\n")
        out.write("    add    r3, r3, #48\n")
        out.write("    cmp    r5, #0 \n")
        out.write("    strb    r3, [ip, #-1]!\n")
        out.write("    mov    r9, r5 \n")
        out.write("    add    r3, r1, #1 \n")
        out.write("    bne    .L5    \n")
        out.write("    cmp    r0, #0 \n")
        out.write("    mvn    r1, r1 \n")
        out.write("    movlt    ip, #45\n")
        out.write("    addlt    r0, sp, #40\n")
        out.write("    addlt    r0, r0, r1\n")
        out.write("    strblt    ip, [r0, #-4]\n")
        out.write("    rsb    r0, r2, #33\n")
        out.write("    add    r1, r0, r1\n")
        out.write("    add    r2, r3, r2\n")
        out.write("    add    r3, sp, #4\n")
        out.write("    add    r1, r3, r1\n")
        out.write("    mov    r0, #1\n")
        out.write("    mov    r7, #4\n")
        out.write("    swi    0\n")
        out.write("    add    sp, sp, #44\n")
        out.write("    pop    {r4, r5, r6, r7, r8, r9, pc}\n")
        out.write(".L9:\n")
        out.write("    .align    2\n")
        out.write(".L8:\n")
        out.write("    .word    1717986919\n")
        out.write("    .word    429496730\n")
        ...
        for ip in range(len(program.ops)):
            ...
            if op.typ in [OpType.PUSH_INT, OpType.PUSH_BOOL, OpType.PUSH_PTR]:
                ...
                assert len(Intrinsic) == 45, "Exhaustive intrinsic handling in generate_gas_linux_arm32()"
