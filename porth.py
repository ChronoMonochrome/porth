...
def generate_gas_linux_arm32(program: Program, out_file_path: str):
    ...
    with open(out_file_path, "w") as out:
        ...
        out.write("    sub	sp, sp, #36\n")
        out.write("    add	r1, sp, #32\n")
        out.write("    ldr	lr, .L6\n")
        out.write("    ldr	ip, .L6+4\n")
        out.write("    strb	r3, [r1, #-1]!\n")
        out.write(".L2:\n")
        out.write("    smull	r6, r7, r0, lr\n")
        out.write("    smull	r4, r5, r0, ip\n")
        out.write("    asr	r3, r0, #31\n")
        out.write("    rsb	r3, r3, r7, asr #2\n")
        out.write("    add	r3, r3, r3, lsl #2\n")
        out.write("    sub	r0, r0, r3, lsl #1\n")
        out.write("    add	r0, r0, #48\n")
        out.write("    cmp	r5, #0\n")
        out.write("    strb	r0, [r1, #-1]!\n")
        out.write("    add	r2, r2, #1\n")
        out.write("    mov	r0, r5\n")
        out.write("    bne	.L2\n")
