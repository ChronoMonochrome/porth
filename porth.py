        ...
        for ip in range(len(program.ops)):
            ...
            if op.typ in [OpType.PUSH_INT, OpType.PUSH_BOOL, OpType.PUSH_PTR]:
                ...
                if op.operand == Intrinsic.PLUS:
                    ...
                    out.write("    pop {r2}\n")
                    out.write("    pop {r9}\n")
                    out.write("    adds r1, r1, r2\n")
                    out.write("    adc r10, r10, r9\n")
                    out.write("    push {r10}\n")
                    out.write("    push {r1}\n")
                elif op.operand == Intrinsic.MINUS:
                    out.write("// PLUS\n")
                    ...
                    out.write("    pop {r2}\n")
                    out.write("    pop {r9}\n")
                    out.write("    subs r2, r2, r1\n")
                    out.write("    sbc r9, r9, r10\n")
                    out.write("    push {r9}\n")
                    out.write("    push {r2}\n")
                elif op.operand == Intrinsic.MUL:
                    out.write("// MUL\n")
                    ...
                    out.write("    pop {r2}\n")
                    out.write("    pop {r9}\n")
                    out.write("    mul r9, r1, r9\n")
                    out.write("    umull r4, r5, r1, r2\n")
                    out.write("    mla r2, r10, r2, r9\n")
                    out.write("    add r5, r2, r5\n")
                    out.write("    mov r1, r4\n")
                    out.write("    mov r10, r5\n")
                    out.write("    push {r10}\n")
                    out.write("    push {r1}\n")
                elif op.operand == Intrinsic.MAX:
                    out.write("    pop {r1}\n")
